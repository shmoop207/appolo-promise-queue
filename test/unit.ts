...
describe("Promise Queue", function () {
    ...
    it('should remove from queue', async () => {
        const queue = new Queue({concurrency: 1, timespan: 100, autoStart: false});
    ...
    it('should run queue with timespan', async () => {
        ...
        const queue = new Queue({concurrency: 1, timespan: 100});
    ...
    it('should run queue with timespan and concurrency', async () => {
        ...
        const queue = new Queue({concurrency: 2, timespan: 100});
